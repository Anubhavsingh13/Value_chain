...
```mermaid
flowchart LR
    A["🪨 Raw Materials\nsteel / aluminium / copper / electronics"] --> B["🔧 Component Mfg\nwheels / bogies / signalling hardware"] --> C["🚂 Rolling Stock Assembly\nlocomotives / coaches / wagons"] --> D["🏗️ Civil Construction\ntrack / OHE / bridges / tunnels"] --> E["🔬 Testing and Certification\nRDSO approval / commissioning"] --> F["🏛️ Railways / Metro / DFCCIL\nowner and operator"] --> G["👤 End Users\nfreight shippers / passengers"] --> H["⚙️ MRO and Overhaul\nPOH / lifecycle services"]
