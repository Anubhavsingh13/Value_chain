...
```mermaid
flowchart LR
    A["🏗️ Land and Permits"] --> B["🧱 Civil Build"] --> C["⚡ Power Infrastructure"] --> D["❄️ Cooling Systems"] --> E["🖥️ IT Hardware"] --> F["🔌 Fiber Connectivity"] --> G["🏢 Colocation and Managed Services"] --> H["👤 End Customers"]
