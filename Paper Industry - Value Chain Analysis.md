...
```mermaid
flowchart LR
    A["🌲 Raw Fibre\nPulpwood · Bagasse\nWheat straw · Waste paper"] --> B["⚗️ Pulping\nChemical / Mechanical\nDe-inking (recycled)"]
    B --> C["🏭 Paper Machine\nForming · Pressing\nDrying · Coating"]
    C --> D["📦 Product\nW&P · Board\nNewsprint · Tissue"]
    D --> E["👤 End User\nPublishers · Printers\nFMCG · E-commerce"]
...
flowchart LR
    subgraph SUPPORT["🔧 Support Activities"]
        S1["🏛️ Governance / Capital\nITC · JK Org · Aditya Birla\nBILT = cautionary tale"]
        S2["♻️ Tech & Sustainability\nBCTMP · ZLD · Chemical recovery\nMoulded fibre (Pakka)"]
        S3["🌱 Procurement / Fibre\nFarm-forestry · Bagasse\nImported waste paper & pulp"]
    end

    A["🌲 FIBRE SOURCING\nITC · JK Paper\nWest Coast · Seshasayee\nTNPL(bagasse) · Satia(agro)"] --> B["⚗️ PULPING\nWood · Agro · Recycled\nCentury · Andhra\nNR Agarwal · Genus"]
    B --> C["🏭 PAPER-MAKING\nJK Paper · West Coast\nKuantum · Emami\nStar · Shreyans"]
    C --> D["📦 PRODUCT & BRAND\nITC(board) · JK Copier\nPudumjee(tissue)\nPakka(CHUK moulded)"]
    D --> E["👤 END USERS\nPublishers · Printers\nFMCG · E-commerce · QSR"]
    ...
    subgraph MARGIN["💰 Margin Capture"]
        M1["🔴 LOW MARGIN\nCommodity W&P & newsprint\n(import-pressured, declining)"]
        M2["🟢 HIGH MARGIN\nPackaging board · Tissue\nMoulded fibre · Branded copier"]
    end
    ...
    style S2 fill:#334155,stroke:#94a3b8,color:#e2e8f0
    style S3 fill:#334155,stroke:#94a3b8,color:#e2e8f0
    style M1 fill:#450a0a,stroke:#ef4444,color:#fecaca
    style M2 fill:#052e16,stroke:#22c55e,color:#bbf7d0
```
