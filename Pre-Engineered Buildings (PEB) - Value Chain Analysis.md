...
```mermaid
flowchart LR
    A["🪨 Hot-Rolled Steel\nCoils & Sections\n(SAIL, JSW, Tata Steel)"] --> B["📐 Engineering &\nDesign\n(Structural design,\n3D modelling, BOM)"] --> C["🏭 PEB Fabrication\n(Primary frames,\nsecondary members,\npurlin, girt, sheeting)"] --> D["📦 Surface Treatment\n& Dispatch\n(Painting, galvanising,\nlogistics to site)"] --> E["🔩 Erection &\nCommissioning\n(Foundation interface,\nbolt-up, cladding)"] --> F["🏗️ End Customer\n(Warehouse, factory,\nlogistics park, hangar)"]
...
flowchart LR
    subgraph SUPPORT["⚙️ Support Activities"]
        direction TB
        FI["🏛️ Firm Infrastructure\nBIS IS-800 · NBC 2016\nDPIIT GatiShakti · CPWD"]
        HR["👥 HR Management\nIIT Madras/Roorkee\nINSDAG Training"]
        TD["🔬 Technology Development\nKirby KEMDA · Interarch Tekla\nSTAAD.Pro · BIM adoption"]
        PR["📦 Procurement\nTata Steel · JSW Steel\nTata BlueScope · Asian Paints"]
    end
    ...
    subgraph MARGIN["💰 Margin Capture"]
        direction TB
        HM["HIGH MARGIN\n• Coated steel IP (BlueScope)\n• Structural design (embedded)\n• EPC management (L&T)"]
        MM["MEDIUM MARGIN\n• Primary fabrication 8–12%\n• Roll-forming 8–10%"]
        LM["LOW MARGIN\n• Erection labour 5–8%\n• Outbound freight 3–5%"]
    end
